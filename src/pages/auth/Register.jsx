...
import login3d from '@/assets/images/login-3d.png';
    ...
    return (
        <div className="h-full w-full bg-[#a0d0ff] flex flex-col md:flex-row items-center relative">
            <div className="flex-[1] p-8 h-full">
                ...
                <img
                    className="hidden md:block w-1/2 absolute bottom-1/2 translate-y-2/3 left-0 pointer-events-none user-select-none"
                    src={login3d}
                    alt="intratech"
                />
            </div>
